...
---
## Unduh Termux
- Buka halaman unduh <a href="https://f-droid.org/en/packages/com.termux/" target="_blank">Termux</a> di F-Droid. Scroll ke bawah untuk mencari aplikasi Termux terbaru, atau <a href="https://f-droid.org/repo/com.termux_118.apk" target="_blank">klik di sini</a> untuk mengunduh Versi 0.118.0 (118) yang diperbarui pada 11 Januari 2022.
