...
/>
- Password default untuk user charis: ch. - Jangan lupa untuk memperbarui modul-modul Ubuntu menggunakan perintah:
<Pre
  codeBlocks={[
    {
...
/>
> CATATAN! Kamu harus mengingat passwordmu untuk [mengakses Ubuntu](#akses-ubuntu) nantinya. - Izin akses root:
<Pre
  codeBlocks={[
    {
      content: `sudo visudo`
...
/>
> Ubah semua `Username` dengan nama yang kamu inginkan. Hal ini untuk mempermudah login hanya dengan `Username` tanpa harus
menulis `proot-distro login ubuntu`. --- ## Mengubah Bahasa ke Indonesia - Unduh paket Bahasa Indonesia:
<Pre
  codeBlocks={[
    {
...
/>
- Mulai ulang Termux. --- ## Akses Ubuntu - Buka AVNC, atur seperti berikut:
<Pre
  codeBlocks={[
    {
...
/>
- Isi `Username` dan `Password` sesuai dengan yang sudah kamu buat. --- ## Instal NVM (Node Version Manager) - Pertama, kamu
perlu menginstal `curl` jika belum terinstal otomatis pada saat melakukan penginstalan Ubuntu.
<Pre
  codeBlocks={[
    {
...
/>
- Lalu unduh NVM menggunakan curl. Ketika kamu menjalankan perintah khusus ini, curl akan mengunduh skrip instalasi NVM.
Setelah itu, bash mengeksekusi skrip yang sama untuk menginstal NVM.
<Pre
  codeBlocks={[
    {
...
/>
- Node versi terbaru telah terinstal, atau gunakan perintah di bawah ini untuk memastikan versi Node yang baru saja kamu
instal:
<Pre
  codeBlocks={[
    {
...
/>
--- ## Ubah Node Default - Jika sudah yakin dengan versi dari Node yang kamu instal, kamu perlu mengatur versi default dari
NVM agar dapat digunakan secara default kapan pun kamu membutuhkannya. Kamu dapat menggunakan perintah di bawah ini untuk
melakukannya. Pastikan untuk mengubah versinya ke versi yang sama persis dengan versi yang telah kamu instal.
<Pre
  codeBlocks={[
    {
      content: `nvm use --lts`
