...
```bash
pkg update -y && pkg upgrade -y && pkg install wget curl proot tar -y && wget https://raw.githubusercontent.com/agcrisbp/LinuxAndroid/master/Installer/Ubuntu22/ubuntu22.sh -O ubuntu22.sh && chmod +x ubuntu22.sh && bash ubuntu22.sh
```
